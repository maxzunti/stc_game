...
//    entities.push_back(crate2);
    ...
    Hook * tHook = new Hook("assets/models/Crate/Crate1.obj", "assets/models/teapot/teapot_tex.png", myPhysics->createBlock(0, 0, 0), myPhysics, 0.f);
   ...
   //     tCrate->setPos(0, 2, 0);
	...
	/*	PxRigidBodyExt::addForceAtLocalPos(*dynamic_cast<PhysicsObject*>(entities.front())->mActor, PxVec3(0, 160, 0), PxVec3(-0.9, -0.9, 0.9));
        ...
        PxRigidBodyExt::addForceAtLocalPos(*car->mActor, PxVec3(0, 0, -40), PxVec3(0, 0, 0));
